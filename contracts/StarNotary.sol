...
contract StarNotary is ERC721 {
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        bytes memory bytesStarName = bytes(tokenIdToStarInfo[_tokenId].name);
        uint256 length = bytesStarName.length;
        //require(length > 0 , "You can't transfer the Star you don't own");
        if(length>0)
        {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender, "You can't transfer the Star you don't own");
